...
class NftCard extends StatefulWidget {
  final Enum source;
  const NftCard({super.key, required this.source});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        widget.source == Source.home ? Navigator.pushNamed(context,
            Subscribe.routeName):Navigator.pushNamed(context, Magazine.routeName);
      },
      child: Card(
        elevation: 3.0,
